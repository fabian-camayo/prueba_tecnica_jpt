...
@Component({
  selector: 'app-humedad-grafico-refresh',
  templateUrl: './humedad-grafico-refresh.component.html',
  styleUrls: ['./humedad-grafico-refresh.component.css']
})

export class HumedadGraficoRefreshComponent implements OnInit {
