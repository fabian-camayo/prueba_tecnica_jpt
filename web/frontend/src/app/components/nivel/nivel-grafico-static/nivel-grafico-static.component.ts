...
@Component({
  selector: 'app-nivel-grafico-static',
  templateUrl: './nivel-grafico-static.component.html',
  styleUrls: ['./nivel-grafico-static.component.css']
})

export class NivelGraficoStaticComponent implements OnInit {
