...
@Component({
  selector: 'app-temperatura-grafico-static',
  templateUrl: './temperatura-grafico-static.component.html',
  styleUrls: ['./temperatura-grafico-static.component.css']
})

export class TemperaturaGraficoStaticComponent implements OnInit {
